...
@ManagedBean(name = "emailChangeBean")
@RequestScoped
public class emailChangeBean {
    ...
    public void init() {
    	...
    	System.out.println("PostConstruct email change");
    ...
    public boolean check(String key,String name) throws Exception{
    	...
    	if(DbConnect.stringifyHash(user.getHashKey()).equals(key)) {
    		...
    		FacesContext.getCurrentInstance().addMessage("messages", new FacesMessage("Email Changed Successfuly!"));
			return true;
		}
		else {
